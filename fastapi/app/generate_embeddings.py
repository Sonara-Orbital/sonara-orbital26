...
#     supabase.table("Song_Vectors").upsert(all_rows).execute()
#     print(f"Upserted {len(all_rows)} embeddings")
#     all_rows = []

# if all_rows:
#    supabase.table("Song_Vectors").upsert(all_rows).execute()
#    print(f"Upserted final {len(all_rows)} rows")
