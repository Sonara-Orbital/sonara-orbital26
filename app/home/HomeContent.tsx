    ...
    import { useSidebar, SidebarInset, SidebarProvider, SidebarTrigger } from "@/components/ui/sidebar";
    ...
    function BottomBar({
        ...
        const { state, isMobile } = useSidebar(); // ✅ safe here

        return (
            <footer
                className={`fixed bottom-0 right-0 z-30 bg-white p-3 transition-all duration-300 border-t
                    ${!isMobile && state === "expanded" ? "left-[var(--sidebar-width)]" : "left-12"}
                `}
            >
                <div className="flex flex-1 flex-col md:flex-row items-center gap-2 w-full px-4 relative">
                    ...
                    <form
                        className={`flex justify-center flex-col transition-all duration-900 ease-in-out ${
                            isPageEmpty
                    ...
                    >
                        <div
                            className={`font-sm text-center mb-2 transition-all duration-200 text-2xl absolute ${
                                isPageEmpty
    ...
    return (
        <SidebarProvider >
            ...
            <SidebarInset className="">
                ...
                <BottomBar searchMode={searchMode} setSearchMode={setSearchMode}
                inputVal={inputVal} setInputVal={setInputVal} isLoading={isLoading}
                isPageEmpty={isPageEmpty} handleSubmit={handleSubmit} />
                {/* </div> */}
                {children}
            </SidebarInset>
        </SidebarProvider>
